...
- [ ] Core: `src/environment_belief/core.py`, package exports, and
  ...
  focused suite.
- [ ] Outputs: `src/environment_belief/outputs.py` and
...
- [ ] Synthetic validation: `src/environment_belief/synthetic.py`,
...
- [ ] Run the three demos into `outputs/a2/`, inspect numerical results and
...
- [ ] Final verification: run all A2 and existing A1 unit tests once with
