...
2026-09-10T04:14:23.642519+00:00
...
- launch-02-hard01-generic: last event `A6_TASK_END`; task-end record True; 1 verified prediction/observation pairs.
  ...
  [Window 2 comparison plot](new_task_acquisition_02_launch-02-hard01-generic_window2.png)
- launch-03-hard01-ours: last event `A5_CAPTURE_ANCHOR`; task-end record False; 1 verified prediction/observation pairs.
  [Window 2 comparison plot](new_task_acquisition_02_launch-03-hard01-ours_window2.png)
