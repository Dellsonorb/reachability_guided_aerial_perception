...
2026-09-10T04:15:43.333868+00:00
...
- launch-02-hard01-generic: last event `A6_TASK_END`; task-end record True; 1 verified prediction/observation pairs.
  ...
  [Window 2 comparison plot](new_task_acquisition_03_launch-02-hard01-generic_window2.png)
- launch-03-hard01-ours: last event `A5_VIEWPOINT`; task-end record False; 2 verified prediction/observation pairs.
  [Window 2 comparison plot](new_task_acquisition_03_launch-03-hard01-ours_window2.png)
  [Window 3 comparison plot](new_task_acquisition_03_launch-03-hard01-ours_window3.png)
