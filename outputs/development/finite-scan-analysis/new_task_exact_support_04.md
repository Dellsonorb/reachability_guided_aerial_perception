...
2026-09-10T04:29:47.500852+00:00
...
| launch-05-moderate01-generic / 1 | 34 | 28 | 6 | 0 | 0 | 0 (0) |
| launch-05-moderate01-generic / 2 | 34 | 28 | 6 | 0 | 0 | 0 (0) |
| launch-05-moderate01-generic / 3 | 34 | 28 | 0 | 6 | 0 | 0 (0) |

Latest available decision details:

- launch-02-hard01-generic, round 2: overlapping blocking causes {'perceived_expanded_target_rectangle': 30, 'observed_ambiguous_endpoint_disks': 29}; confirmed sources []. Task-end recorded: True.
...
- launch-03-hard01-ours, round 3: overlapping blocking causes {'observed_ambiguous_endpoint_disks': 29, 'perceived_expanded_target_rectangle': 31}; confirmed sources [623, 542, 581]. Task-end recorded: True.
...
- launch-04-moderate01-ours, round 2: overlapping blocking causes {'perceived_expanded_target_rectangle': 30, 'observed_ambiguous_endpoint_disks': 28}; confirmed sources [582, 542]. Task-end recorded: True.
...
- launch-05-moderate01-generic, round 3: overlapping blocking causes {'perceived_expanded_target_rectangle': 28, 'observed_ambiguous_endpoint_disks': 27}; confirmed sources [582, 542, 501, 500, 539, 579]. Task-end recorded: False.
